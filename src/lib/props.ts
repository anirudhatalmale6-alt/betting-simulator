...
const SPORT_PROPS: Record<string, PropTemplate[]> = {
  baseball: [
    ...
    { category: 'Game Props', description: 'Run Scored in 6th Inning', type: 'yes_no', prob: 0.34 },
    { category: 'Game Props', description: 'Run Scored in 7th Inning', type: 'yes_no', prob: 0.36 },
    { category: 'Game Props', description: 'Run Scored in 8th Inning', type: 'yes_no', prob: 0.35 },
    { category: 'Game Props', description: 'Run Scored in 9th Inning', type: 'yes_no', prob: 0.33 },
    { category: 'Game Props', description: 'First 5 Innings Total Runs', line: 4.5, type: 'over_under', prob: 0.48 },
    { category: 'Game Props', description: 'First 5 Innings Run Line', line: 0.5, type: 'over_under', prob: 0.50 },
